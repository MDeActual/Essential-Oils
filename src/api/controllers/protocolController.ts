 ...
 */
export function createProtocolController(protocolService: ProtocolService): {
  listProtocols: (req: Request, res: Response, next: NextFunction) => Promise<void>;
  getProtocol: (req: Request, res: Response, next: NextFunction) => Promise<void>;
} {
 ...
 */
  ...
  return { listProtocols, getProtocol };
}
